...
namespace utils {
	...
	namespace {		// Anonymous namespace to ensure that the next template functions are not exported
		...
		*/
		...
		//// partition around a given pivot
		//template<typename T>
		//int partition_around_pivot(T* input, int leftIdx, int rightIdx, int pivot) {
		...
		//		if (left == pivotIdx) // keep track of the pivotIdx in both directions
		//		{
		//			pivotIdx = right;
